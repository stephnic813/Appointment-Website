                    ...
                    <center>
                        ...
                        echo     '       </select><br><br>
                           ...
                           <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="type" class="form-label">Select Session Type: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                        ...
                        <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="place" class="form-label">Select Session Place: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <select name="place" id="" class="box" >
                        ...
                        echo     '       </select><br><br>
                            ...
                            <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="link" class="form-label">Session Place Link: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="link" class="input-text" placeholder="Session Place Link" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
